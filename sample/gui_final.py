...
if __name__ == '__main__':
    ...
    parser.add_argument('-i','--indir', help='The directory to start searching for files')
    parser.add_argument('-s','--suffix', help='Suffix of files to search on')
    args = parser.parse_args()

    file_paths = find_csv_filepaths(args.indir, args.suffix)
    mapped_genes = map_genes_to_file_paths(file_paths, args.suffix)
